...
// Zero-dependency .env loader (local dev). Hosting platforms inject env vars themselves.
try {
...
// simple per-IP rate limit: 30 req/min
const hits = new Map();
...
// Streaming chat proxy (SSE passthrough)
...
// Image generation proxy (Gemini image model with Imagen-3 fallback)
